...
#     if args.Accel_name == "Accel8":
#     	xtrain = torch.load("xtrain25000022x22float32.pth")
#     	xval = torch.load("xval4412022x22float32.pth" )
#     	xtest = torch.load("xtest4527022x22float32.pth")   
#     else:
...
#         self.X = torch.tensor(X, dtype=torch.float32)  # Convert X to tensor of float32
